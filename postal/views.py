...
class ArticleDebateView(ListView):
    queryset = Article.objects.filter(article__title__contains='debate').order_by('pk') # <app_name>/<model_name>_list.html #this is the default path it looks for template 
    model = Article
